...
**백엔드부터 프론트엔드까지, 서비스 전체를 설계하고 구현하는 풀스택 개발자입니다.**  
AI 기능 통합과 실시간 시스템 구축에 관심이 많으며,  
현재는 AI 기반 생활 플랫폼 **sora-api**를 개발 중입니다.
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h4><a href="https://github.com/M1NiDRAG0N/sora-api">🤖 sora-api</a></h4>
      <p>AI 어시스턴트 <b>"소라 고동"</b>이 자연어 명령으로 모든 기능을 실행하는 AI 통합 생활 플랫폼</p>
      <ul>
        <li>💰 가계부 / 수입·지출 관리 + 차트 시각화</li>
        <li>🛒 중고거래 마켓 + 키워드 알림</li>
        <li>💬 커뮤니티 게시판 + 실시간 채팅 (WebSocket)</li>
        <li>⚡ 플래시세일 + 구글맵 연동</li>
        <li>🔔 SSE 실시간 알림</li>
      </ul>
      <p>
        ...
        <img src="https://img.shields.io/badge/Groq_AI-412991?style=flat-square&logo=meta&logoColor=white"/>
        <img src="https://img.shields.io/badge/Redis-FF4438?style=flat-square&logo=redis&logoColor=white"/>
        <img src="https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white"/>
      </p>
      <blockquote>k6 부하 테스트로 에러율 99.3% → 0% 개선, 응답시간 63% 단축</blockquote>
    </td>
    <td width="50%" valign="top">
      <h4><a href="https://github.com/M1NiDRAG0N/SpringBoot">☕ SpringBoot</a></h4>
      <p>Spring Boot + MyBatis + MySQL 기반 웹 프로젝트</p>
      <br/>
      <h4><a href="https://github.com/M1NiDRAG0N/Hika-flutter">🎌 Hika-flutter</a></h4>
      <p>히라가나 & 가타카나 퀴즈 앱 (Flutter/Dart)</p>
      <br/>
      <h4><a href="https://github.com/M1NiDRAG0N/global-interview-skill">🌏 global-interview-skill</a></h4>
      <p>KR/JP/US 다국적 페르소나 기반 개발자 면접 코칭 AI 스킬</p>
    </td>
  </tr>
</table>
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=M1NiDRAG0N&show_icons=true&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true" height="165"/>
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=M1NiDRAG0N&layout=compact&theme=tokyonight&hide_border=true&langs_count=8" height="165"/>
</div>

<div align="center">
  <img src="https://streak-stats.demolab.com/?user=M1NiDRAG0N&theme=tokyonight&hide_border=true" width="60%"/>
</div>

<div align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=M1NiDRAG0N&theme=tokyo-night&hide_border=true&area=true" width="95%"/>
</div>
...
**バックエンドからフロントエンドまで、サービス全体を設計・実装するフルスタック開発者です。**  
AI機能の統合とリアルタイムシステムの構築に強い関心を持っており、  
現在はAIベースのライフスタイルプラットフォーム **sora-api** を開発中です。
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h4><a href="https://github.com/M1NiDRAG0N/sora-api">🤖 sora-api</a></h4>
      <p>AIアシスタント <b>「ソラ ゴドン」</b> が自然言語コマンドで全機能を実行するAI統合ライフスタイルプラットフォーム</p>
      <ul>
        <li>💰 家計簿 / 収支管理 + チャート可視化</li>
        <li>🛒 フリマアプリ + キーワードアラート</li>
        <li>💬 コミュニティ掲示板 + リアルタイムチャット (WebSocket)</li>
        <li>⚡ フラッシュセール + Google マップ連携</li>
        <li>🔔 SSEリアルタイム通知</li>
      </ul>
      <p>
        <img src="https://img.shields.io/badge/Java_21-ED8B00?style=flat-square&logo=openjdk&logoColor=white"/>
      ...
      <blockquote>k6負荷テストにてエラー率99.3% → 0%改善、レスポンスタイム63%短縮</blockquote>
    </td>
    <td width="50%" valign="top">
      <h4><a href="https://github.com/M1NiDRAG0N/SpringBoot">☕ SpringBoot</a></h4>
      <p>Spring Boot + MyBatis + MySQL ベースのWebプロジェクト</p>
      <br/>
      <h4><a href="https://github.com/M1NiDRAG0N/Hika-flutter">🎌 Hika-flutter</a></h4>
      <p>ひらがな・カタカナ クイズアプリ (Flutter/Dart)</p>
      <br/>
      <h4><a href="https://github.com/M1NiDRAG0N/global-interview-skill">🌏 global-interview-skill</a></h4>
      <p>KR/JP/US 多国籍ペルソナによる開発者面接コーチング AIスキル</p>
    </td>
  </tr>
</table>
